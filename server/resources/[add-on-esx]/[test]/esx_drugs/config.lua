...
Config.Zones = {
	...
	---------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------------------------------------------------------------------------------------
	--MethField           = {x=2299.642, y=-1638.519, z=89.178,   name = _U('meth_field'),         sprite = 499,    color = 26},
	--MethlabField        = {x=1956.104,  y=5053.0,    z=41.413,   name = _U('methlab_field'),      sprite = 499,    color = 26},
	...
	---------------------------------------------------------------------------------------------------------------------------
	---------------------------------------------------------------------------------------------------------------------------
    WeedField           = {x=3659.7,  y=4574.0,    	z=25.4,   name = _U('weed_field'),         sprite = 496,    color = 52},
	WeedProcessing      = {x=371.9,  y=-1791.2,   	z=29.1,  name = _U('weed_processing'),    sprite = 496,    color = 52},
	WeedDealer          = {x=1111.2,   y=-462.3, z=68.1,   name = _U('weed_dealer'),        sprite = 500,    color = 75},
	---------------------------------------------------------------------------------------------------------------------------
