Locales['fr'] = {
  ...
  ['move_out_sold'] = 'Vendre la propiété pour <span style="color:green;">$%s</span>',
  ...
  ['rent'] = 'Loué la propriété pour <span style="color:green;">$%s</span> / week',
  ['rent_for'] = 'vous avez louer une propriété pour ~g~$%s~s~',
