...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/mdtpd', ' Terminal de données Mobile Police', {})	
	end
...
RegisterNetEvent('Lrp:tabletmdtpd')
AddEventHandler('Lrp:tabletmdtpd', function()
...
SetNuiFocus(true, true)
	...
	exports['mythic_notify']:DoCustomHudText('cajaroja', ' Vous n’êtes pas policier ou en service pour utiliser cette commande ',3500)
end
