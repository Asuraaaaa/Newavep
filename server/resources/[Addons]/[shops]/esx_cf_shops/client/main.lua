...
Citizen.CreateThread(function()
	...
	mainMenu = NativeUI.CreateMenu("", "Bienvenue chez Apu!", 5, 50, "shopui_title_gasstation", "shopui_title_gasstation")
	...
	while true do
		while _menuPool ~= nil and _menuPool:IsAnyMenuOpen() do
			...
			if not _menuPool:IsAnyMenuOpen() then
				mainMenu:Clear()
				_menuPool = NativeUI.CreatePool()
				mainMenu = NativeUI.CreateMenu("", "Bienvenue chez Apu!", 5, 100, "shopui_title_gasstation", "shopui_title_gasstation")
				_menuPool:Add(mainMenu)
			end
		end
